				...
				<div id="op1" class="col-sm-3 padd">
					<center>
						<span> <img src="images/patients/my appointment.png"
							id="img" style="margin-top: 35px; margin-bottom: 15px">
						</span>
						<h4>My Appointment</h4>
						<a href="patientbookApp.jsp" id="link">Book Appointment</a>
					</center>
					<br>
				</div>
				<div class="col-sm-2"></div>
				<div id="op1" class="col-sm-3 padd">
					...
					<center>
						<span><img src="images/patients/appointment-hist.png"
							id="img"></span> <br>
						<br>
						<h4>My Appoinments</h4>
						<a href="Appointment_history.jsp" id="link">View Appoinment
							History</a>
					</center>
					<br>
				</div>

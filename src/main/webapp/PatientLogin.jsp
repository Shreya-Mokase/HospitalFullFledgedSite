...
<head>
<title>Patient Login -Bhave's Multispeciality hospital</title>
<link rel="stylesheet"
			...
			<div class="container-fluid h-custom">
				<div class="row d-flex justify-content-center align-items-center"
					...
					<div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1 temp">
						<form action="PatientAuthenticate" method="POST">
							<div
						...
						<br>
						<div id="register">
							<a href="Patient_register.jsp" class="registerLink"
								style="color: #001f33;">Don't have Account? create one!</a>
						</div>
					</div>
				</div>
			</div>

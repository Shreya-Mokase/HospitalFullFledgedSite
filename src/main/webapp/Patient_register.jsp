...
<head>
<title>Register Patient- Bhave's Multispeciality hospital</title>
<link rel="stylesheet"
			...
			<div class="content">
				<form action="Patient_register" method="POST">
					<div class="user-details">
						...
						<div class="input-box">
							<span class="details">DOB</span> <input type="date" id="dob"
								name="dob" onChange="TDate()" required>
						</div>
						<script>
             function TDate() {
            	    ...
            	    if (new Date(UserDate).getTime() > ToDate.getTime()) {
            	          alert("Invalid Date!!");
            	          document.getElementById("dob").value="Select Date";
            	          return false;
            	     }
            	    return true;
            	}
						...
						<div class="input-box">
							<span class="details">Height</span> <input type="number"
								placeholder="Enter your Height" name="height" required>
						</div>
						<div class="input-box">
							<span class="details">Weight</span> <input type="number"
